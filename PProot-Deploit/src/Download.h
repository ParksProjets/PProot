...
private:
    ...
    static unsigned long openfile(string file, bool reload, ofstream &fout);


public:

    static bool download(string url, string dest, bool reload=false, void (*update)(unsigned long, unsigned long)=NULL);
};
